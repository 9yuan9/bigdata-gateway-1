...
//    }
    ...
    private static void init(){
		...
		try {
	        ...
	        FileInputStream instream = new FileInputStream(new File("/Users/guoxin/Documents/微应相关/证书/cert/apiclient_cert.p12"));//加载本地的证书进行https加密传输
	        try {
	            keyStore.load(instream, "1480631902".toCharArray()/*Configure.getCertPassword().toCharArray()*/);//设置证书密码
	        ...
	        SSLContext sslcontext = SSLContexts.custom()
	                .loadKeyMaterial(keyStore, "1480631902".toCharArray()/*Configure.getCertPassword().toCharArray()*/)
	                .build();
