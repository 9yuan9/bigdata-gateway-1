...
//package com.gxcode.mp.account.core.utils;
//
...
//
//import com.gxcode.mp.common.utils.MD5;
//import com.gxcode.mp.common.utils.XmlBeanUtils;
//
//public class MpPaySignatureUtils {
//    /**
//     * 签名算法
//     * @param o 要参与签名的数据对象
//     * @return 签名
...
//        result = MD5.crypto(result).toUpperCase();
...
//    	Map<String,Object> map = XmlBeanUtils.xmlStrToMap(responseString);
//        //清掉返回数据对象里面的Sign数据（不能把这个数据也加进去进行签名），然后用签名算法进行签名
//        map.put("sign","");
//        //将API返回的数据根据用签名算法进行计算新的签名，用来跟API返回的签名进行比较
//        return MpPaySignatureUtils.getSign(map,key);
//    }
//
//    /**
...
//        if(signFromAPIResponse.equals("") || signFromAPIResponse == null){
...
//        map.put("sign","");
//        //将API返回的数据根据用签名算法进行计算新的签名，用来跟API返回的签名进行比较
//        String signForAPIResponse = MpPaySignatureUtils.getSign(map,key);
//
